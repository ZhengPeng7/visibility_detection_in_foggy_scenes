...
def inception_v4(num_classes=1000, dropout_keep_prob=0.2, weights='imagenet', include_top=True, input_shape=(229, 229)):
    '''
    ...
    if K.image_data_format() == 'channels_first':
        inputs = Input((3, input_shape[0], input_shape[1]))
    else:
